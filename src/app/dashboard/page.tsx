// src/app/dashboard/page.tsx — FINAL: Blue gradient VISIBLE on content + chip row
'use client';
...
export default function CoachDashboard() {
  ...
  const chips = [
    ...
    { id: 'stats', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 0 01-2 2h-2a2 2 0 01-2-2z' },
  ...
  return (
    <div className="min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('/white-honeycomb.png')" }}>
      <div className="min-h-screen bg-black/70 backdrop-blur-sm flex flex-col">
        ...
        {/* Content Area — BLUE GRADIENT VISIBLE */}
        <main className="flex-1 mx-6 mt-6 pb-32">
          <div className="bg-gradient-to-b from-blue-800/50 via-blue-900/30 to-transparent backdrop-blur-2xl border border-blue-500/30 rounded-3xl p-6 shadow-2xl">
            {activeTab === 'roster' ? (
              <>
                {/* Role Tabs */}
        ...
        {/* Bottom Chip Row — BLUE GRADIENT VISIBLE */}
        <div className="fixed bottom-0 left-0 right-0 z-50">
          <div className="mx-6 mb-8">
            <div className="bg-gradient-to-b from-blue-800/50 via-blue-900/30 to-transparent backdrop-blur-2xl border border-blue-500/30 rounded-full p-4 shadow-2xl">
              <div className="flex justify-center gap-8">
                {chips.map((chip) => (
                  <button key={chip.id} onClick={() => setActiveTab(chip.id as Tab)} className="transition-transform hover:scale-110">
